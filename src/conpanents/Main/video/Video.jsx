...
function Video() {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener("resize", handleResize); // Слушаем событие изменения размера
    return () => {
      window.removeEventListener("resize", handleResize); // Убираем слушателя при размонтировании
    };
  }, []);
